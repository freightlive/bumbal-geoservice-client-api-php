...
/**
 * ApiUserModel Class Doc Comment
 *
 * @category    Class
 * @package     GeoService
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ApiUserModel implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ApiUserModel';
    ...
    /**
     * Sets name
     * @param string $name ApiUser name
     * @return $this
     */
    ...
    /**
     * Sets active
     * @param int $active ApiUser active
     * @return $this
     */
    ...
    /**
     * Sets apikey
     * @param string $apikey ApiUser Apikey (When left empty on creation, an apikey will be generated)
     * @return $this
     */
